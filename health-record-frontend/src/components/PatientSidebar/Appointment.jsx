...
//                   <h3 className="font-semibold mt-1">Dr. Emily Watson</h3>
//                 </div>

//                 <div className="bg-white/10 rounded-2xl p-4 backdrop-blur-sm">
//                   <p className="text-sm text-white/70">Date & Time</p>
//                   <h3 className="font-semibold mt-1">24 May • 10:00 AM</h3>
//                 </div>

//                 <div className="bg-white/10 rounded-2xl p-4 backdrop-blur-sm">
//                   <p className="text-sm text-white/70">Type</p>
//                   <h3 className="font-semibold mt-1">In-Person Visit</h3>
//                 </div>
//               </div>
//             </div>
