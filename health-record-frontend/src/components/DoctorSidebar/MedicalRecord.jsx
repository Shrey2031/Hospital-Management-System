...
//               View and manage patient lab reports & diagnostics.
//             </p>
//           </div>
...
//                   <h3 className="font-semibold mb-1">Review MRI - Michael Brown</h3>
//                   <p className="text-gray-400 text-sm mb-3">Due today</p>
